...
export default function Component() {
  ...
  const handleClick = async () => {
    await createAuction({
      chainId: 56, // Chain id of the Asset to put on auction
      collectionAddress: '0x1e4fc916afcf548a2e62c5865fefe2069755a3a3', // Collection address of the Asset to put on auction
      tokenId:
        '26744308925107717638226399784052410886289158766077164738526328260523943400243', // Token id of the Asset to put on auction
...
```tsx
{
  chainId: number // Chain id of the Asset to put on auction
  collectionAddress: string // Collection address of the Asset to put on auction
  tokenId: string // Token id of the Asset to put on auction
