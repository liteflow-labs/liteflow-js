...
[View the env example file](https://github.com/liteflow-labs/marketplace-template/blob/main/.env.example)

### App configuration

To configure behaviors and texts of your application, you can edit the file [App file](https://github.com/liteflow-labs/marketplace-template/blob/main/pages/_app.tsx) that contains the information for the footer, metadata, wallet connectors, and so on.

You can also configure the page's templates in the different [pages](https://github.com/liteflow-labs/marketplace-template/tree/main/pages).
