...
You can create a listing for any NFTs you own directly on the Liteflow dashboard.
...
Click on the 'Create' button to open the form to create a listing for an NFT.
...
If the NFT is on a different network than your current wallet is, you need to switch to the right network. Open your wallet and select the right network. You will need to login again and come back to this page.
