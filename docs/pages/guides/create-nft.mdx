...
If your collection is not listed but is listed in [Collections](https://dashboard.liteflow.com/collections) section, it means your wallet is not authorized to create an NFT on this collection. Make sure your are login with the right wallet.
