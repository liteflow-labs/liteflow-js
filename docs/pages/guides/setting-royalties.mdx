---
title: 'Setting Royalties'
---

import { Steps, Callout } from 'nextra-theme-docs'

# Setting Royalties for Collections

This guide provides instructions for platform owners and collection owners on how to set royalties for a collection using the Liteflow dashboard.
...
Access the Liteflow dashboard and navigate to the ["Collections" section](https://dashboard.liteflow.com/collections) to view all collections you own.
