...
Liteflow webhooks have built-in retry mechanisms for handling 3xx, 4xx, and 5xx response status codes.

## Step 4: Register Your HTTPS URL

To connect your webhook to your Liteflow account, go to your admin panel and add your newly created endpoint in the webhook section.

#### Local Development Considerations

Webhooks must be publicly accessible and cannot be hosted on `localhost`. To test webhooks locally, you can use tools such as [ngrok](https://ngrok.com/) or [localtunnel](https://theboroer.github.io/localtunnel-www).
