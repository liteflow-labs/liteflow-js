...
[Set up a drop](/guides/drop) via the [dashboard](/tools/dashboard) to allow users to mint a predefined number of NFTs through custom rules, available through the [marketplace template](/templates/marketplace).
